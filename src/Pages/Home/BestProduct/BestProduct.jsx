...
const BestProduct = () => {
  return (
    <Fragment>
      <Container className="text-center text-sm-start text-md-start text-lg-start">
            ...
            <Row>
              ...
              <Col lg={6} md={12} sm={12} className="p-2">
                ...
                <p className="text-justify">
                  ...
                  1920s and '30s Minerva watches used for military exploration.
                </p>
            ...
            <Row>
              ...
              <Col lg={6} md={12} sm={12} className="p-2">
                ...
                <p className="text-justify">
                  ...
                  symbol since its invention in 1968. This watch is the best of
                  both worlds: an elegant timepiece and stunning piece of
                  jewelry,
                </p>
            ...
            <Row>
              ...
              <Col lg={6} md={12} sm={12} className="p-2">
                ...
                <p className="text-justify">
                  ...
                  most notable—and coveted—styles, the Reverso, features a face
                  that flips over to protect casing.
                </p>
